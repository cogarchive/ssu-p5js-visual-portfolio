function setup() {
  ...
  noStroke()
  fill("#62c6c4")
  rect(600/3*0,0, 600/3*1, 400)
  fill("#02a6cb")
  rect(600/3*1,0, 600/3*2, 400)
  fill("#006e93")
  rect(600/3*2,0, 600/3*3, 400)
}
...
function draw() {
  ...
  fill("white")
  noStroke()
  ellipse(300, 400 - 10, 5, 5)
  ellipse(300, 400 - 25, 5, 5)
  ellipse(300, 400 - 40, 5, 5)
  ellipse(300, 400 - 55, 5, 5)
